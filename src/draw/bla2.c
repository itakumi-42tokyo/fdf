...
/*   Updated: 2025/08/12 04:41:55 by itakumi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	process_persp(t_control *ctrl, int i, int j)
{
	int	xy0[2];
	int	xy1[2];
...
static void	process_iso(t_control *ctrl, int i, int j)
{
	int	xy0[2];
	int	xy1[2];
