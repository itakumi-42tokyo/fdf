...
/*   Updated: 2025/08/11 18:40:18 by itakumi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	fg_b = fg_color & 0xFF;
// 	r = (int)((1 - alpha) * bg_r + alpha * fg_r);
// 	g = (int)((1 - alpha) * bg_g + alpha * fg_g);
// 	b = (int)((1 - alpha) * bg_b + alpha * fg_b);
// 	return ((r << 16) | (g << 8) | b);
// }
...
// 		iy = (int)y;
// 		dist = x - ix;
// 		blended_color = blend_colors(gb_color, fg_color, dist);
...
// 	if (x == true)
// 	{
// 		scaled = (int)((point - ctrl->iso_min_x0_y1[0]) * ctrl->scale
// 				+ (ctrl->win_size_x * 0.05));
// 	}
// 	else
// 	{
// 		scaled = (int)((point - ctrl->iso_min_x0_y1[1]) * ctrl->scale
// 				+ (ctrl->win_size_y * 0.05));
// 	}
// 	// printf("-------------\n");
// 	// printf("point: %d\n", point);
...
// 			{
// 				x0 = calc_scale(*ctrl, (*ctrl)->iso_map[i][j].iso_x, true)
// 					+ (*ctrl)->offset_x - 500;
// 				y0 = calc_scale(*ctrl, (*ctrl)->iso_map[i][j].iso_y, false)
// 					+ (*ctrl)->offset_y - 500;
// 				x1 = calc_scale(*ctrl, (*ctrl)->iso_map[i][j + 1].iso_x, true)
// 					+ (*ctrl)->offset_x - 500;
// 				y1 = calc_scale(*ctrl, (*ctrl)->iso_map[i][j + 1].iso_y, false)
// 					+ (*ctrl)->offset_y - 500;
// 				// printf("----------\n");
// 				// printf("x0:%d; y0:%d\n", x0, y0);
// 				// printf("x1:%d; y1:%d\n", x1, y1);
...
// 				y0 = calc_scale(*ctrl, (*ctrl)->iso_map[i][j].iso_y, false)
// 					+ (*ctrl)->offset_y - 500;
// 				x1 = calc_scale(*ctrl, (*ctrl)->iso_map[i + 1][j].iso_x, true)
// 					+ (*ctrl)->offset_x - 500;
// 				y1 = calc_scale(*ctrl, (*ctrl)->iso_map[i + 1][j].iso_y, false)
// 					+ (*ctrl)->offset_y - 500;
// 				// printf("----------\n");
// 				// printf("x0:%d; y0:%d\n", x0, y0);
// 				// printf("x1:%d; y1:%d\n", x1, y1);
